...
if (['ьгеу', 'mute', 'мут'].includes(command) && message.member.roles.some(r=>[moder, owner].includes(r.id))) {
    ...
    if(['piar'].includes(command) && message.member.roles.some(r=>[owner].includes(r.id))) {
        ...
        let piaredPeople = ['242975403512168449', '337364672774930443', '303095648574504960', '375962690448916480', '253990640101097474', '253188810001612801', '260349600265797644', '386138135513399306', '251444108680232961', '359768966807289877', '265817540599611392']
